package com.hollis.llm.rag.rerank;
...
public class ReRankUtil {
     ...
     * 使用qwen3-rerank重排序
     */
    public static List<String> rerankFusion(List<Document> vectorDocs, List<EsDocumentChunk> keywordDocs, String query,
        ...
        // 补充自己的apikey
        headers.set("Authorization", "Bearer sk-ws-H.REHIDMR.CNbB.MEUCICLPGNjORqo690TPxr5hdFwUhFdIQek0Wz3lakGdPKZvAiEAnaolf593IuZY27Wo0PcTkFjJO8FjmXU7El9hdGtovLk");
